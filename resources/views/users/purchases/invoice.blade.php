     ...
     <div class="card-body">
       ...
       <div class="invoice_items">
       	  <table class="table  table-borderless">
              ...
              <tbody>
                 @foreach($invoice->items as $key => $item)
                  <tr>
                      ...
                      <td class="text-right">
                          <form method="post" action="{{ route('user.purchases.delete_items',['id'=>$user->id,'invoice_id' => $invoice->id, 'item_id' => $item->id]) }}">
              ...
              <tr>
                <th>
                     <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newPaymentForInvoice">
...
<div class="modal fade" id="newProduct" tabindex="-1" aria-labelledby="#newProductLabel" aria-hidden="true">
  <div class="modal-dialog">
    {!! Form::open(['route' => ['user.purchases.add_items',['id'=>$user->id,'invoice_id'=>$invoice->id]],'method'=>'post']) !!}
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newProductLabel">Add New Product</h5>
      ...
      <div class="modal-body">
         ...
         <!--form start --->
          ...
          <div class="mb-3  form-group row">
            ...
            <div class="col-sm-9">
              {{Form::text('price',NULL,['class'=>'form-control','required', 'id' => 'price','onkeyup' => 'getTotal()','placeholder'=>'Price'])}}
            </div>
          </div>
          ...
          <div class="mb-3  form-group row">
            ...
            <div class="col-sm-9">
              {{Form::text('quantity',NULL,['class'=>'form-control','required', 'id' => 'quantity', 'onkeyup' => 'getTotal()','placeholder'=>'quantity'])}}
            </div>
          </div>
          <div class="mb-3  form-group row">
...
<div class="modal fade" id="newPaymentForInvoice" tabindex="-1" aria-labelledby="#newPaymentForInvoiceLabel" aria-hidden="true">
  <div class="modal-dialog">
    {!! Form::open(['route' => ['user.payments.store', [$user->id,$invoice->id]],'method'=>'post']) !!}
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newPaymentForInvoiceLabel">New Payment for this Invoice</h5>
