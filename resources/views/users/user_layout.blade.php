    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <!--form start --->
          ...
          <div class="mb-3  form-group row">
            <label for="challan_no" class="col-sm-3 col-form-label">Challan Number<span class="text-danger">*</span></label>
            <div class="col-sm-9">
...
<div class="modal fade" id="newPurchase" tabindex="-1" aria-labelledby="#newPurchaseLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newPurchaseLabel">New Purchase</h5>
